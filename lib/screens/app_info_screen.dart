...
import 'package:qingmooo/screens/app_descriptions_screen.dart';
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: _buildCard(
                  title: '应用介绍',
                  content: AppInfo.fullDescription,
                ),
              ),
              const SizedBox(height: 16),
              ...
              Padding(
                ...
                child: _buildCard(
                  title: '我们的用户',
                  content: AppInfo.targetAudience,
                ),
              ),
              const SizedBox(height: 16),
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const AppDescriptionsScreen(),
                      ),
                    );
                  },
                  child: Container(
